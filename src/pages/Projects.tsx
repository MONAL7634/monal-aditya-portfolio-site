  ...
  const projects = [
    {
      ...
      description: 'Developed an intuitive event management website using React, React Router, and Tailwind CSS to simplify event creation, booking, and management. Implemented RESTful APIs with Express.js and Node.js, leveraging MongoDB for efficient data storage and retrieval. Integrated JWT for secure user authentication and role-based authorization.',
    ...
    },
    {
      ...
      description: 'Built a comprehensive pathology management web application for both to book tests, access reports, and manage lab operations. Utilized React Router and Tailwind CSS to create a responsive and user-friendly interface. Implemented robust RESTful APIs with Express.js and Node.js, leveraging MongoDB for scalable and efficient data storage and retrieval. Integrated JWT for secure user authentication.',
      technologies: ['React', 'Node.js', 'Express.js', 'MongoDB', 'Tailwind CSS', 'JWT', 'Redux', 'Multer'],
      image: '/lovable-uploads/9ddc38e1-e86c-47fa-bb7d-522800a0755b.png',
      codeLink: 'https://github.com/MONAL7634',
      date: 'Oct 2024',
    },
    {
      ...
      image: '/lovable-uploads/fbc80cc8-a1dc-4176-989f-2c8fd4fa13aa.png',
      codeLink: 'https://github.com/MONAL7634',
      date: 'July 2024',
    },
  ];
